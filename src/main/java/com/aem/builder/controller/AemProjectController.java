...
log.info("exits:{}:",exists);
    ...
    public String saveConfig(@ModelAttribute AemProjectModel aemProjectModel, Model model,  RedirectAttributes redirectAttributes) {
        try {
            aemProjectService.generateAemProject(aemProjectModel);
            redirectAttributes.addFlashAttribute("message", aemProjectModel.getProjectName()+" Project created successfully.");
